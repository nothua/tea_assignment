...
class AppColors {
  ...
  static const Color gradientEnd = Color(0xFFE0E3FF);
  static const Color loginButtonColor = Color(0xFF8060FF);
  static const Color createAccountButtonColor = Color(0xFFFFFFFF);
  static const Color loginTextColor = Color(0xFF333333);
